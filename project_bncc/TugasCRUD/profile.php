...
// Jika tidak login, kembali ke login.php
if (!isset($_SESSION['user_id'])) {
    echo "<script>alert('Session ID tidak ditemukan! Pastikan Anda sudah login.'); window.location.href='index.php';</script>";
    exit;
}

$id = $_SESSION['user_id']; // Ambil ID dari session
...
$user = $user[0]; // Ambil data user pertama jika query mengembalikan array
?>
